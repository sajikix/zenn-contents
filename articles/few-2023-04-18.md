---
title: "Next.jsのapp ディレクトリでVanilla Extract がサポート予定など (2023-04-18号)" # 目立ったニュースを選ぶ
emoji: "🔔" # お好きな絵文字を
...
Next.js の app dir で Vanilla Extract がサポートされる予定です。(対応する[PR](https://github.com/vercel/next.js/pull/48306)は執筆時点の 2023/04/20 で最新バージョンの Canary にのみ入っています。)
