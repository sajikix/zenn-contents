...
次回[23 日目](https://zenn.dev/sajikix/articles/intl-advent-calendar-24-23)では、Intl で統一的な文言フォーマットを策定しようと言う野心的な試み、Intl.MessageFormat Proposal についてその基本となる部分を解説します。
